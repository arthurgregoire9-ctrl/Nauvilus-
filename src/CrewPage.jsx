...
export default function CrewPage() {
 ...
 const buildSystem = () => {
    ...
    return [
      ...
      "Before proposing ANY dish OR generating ANY menu, mentally scan EVERY ingredient of EVERY dish against EVERY guest's allergies, dislikes AND diet. This includes garnishes, dressings, and minor components. If ANY ingredient conflicts with ANY guest, the dish is INVALID and must be replaced entirely.",
