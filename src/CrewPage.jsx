...
export default function CrewPage() {
  ...
  const buildSystem = () => {
    ...
    return [
     ...
     "- ONLY mention an adaptation if the ingredient appears EXPLICITLY in the guest's allergy or dislike list above. Nothing else justifies an adaptation.",
"- Do NOT infer restrictions from cuisine preferences. Do NOT assume. Do NOT interpret. Only use what is explicitly written in the guest profile.",
"- If parmesan is not in Charlotte's allergy or dislike list, Charlotte eats parmesan. Period.",
